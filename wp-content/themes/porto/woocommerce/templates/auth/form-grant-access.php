...
<div class="wc-auth-logged-in-as">
	...
	<p><?php printf( __( 'Đã đăng nhập với tư cách %s', 'woocommerce' ), esc_html( $user->display_name ) ); ?> <a href="<?php echo esc_url( $logout_url ); ?>" class="wc-auth-logout"><?php _e( 'Thoát', 'woocommerce' ); ?></a>
</div>
