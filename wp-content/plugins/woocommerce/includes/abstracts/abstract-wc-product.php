...
class WC_Product {
	...
	public function single_add_to_cart_text() {
		return apply_filters( 'woocommerce_product_single_add_to_cart_text', __( 'Đặt hàng ngay', 'woocommerce' ), $this );
	}
	...
	public function add_to_cart_text() {
		return apply_filters( 'woocommerce_product_add_to_cart_text', __( 'Xem chi tiết', 'woocommerce' ), $this );
	}
